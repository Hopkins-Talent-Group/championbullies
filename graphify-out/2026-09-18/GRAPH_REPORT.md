...
## Corpus Check
- 54 files · ~968,482 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 332 nodes · 468 edges · 34 communities (16 shown, 9 thin omitted)
...
Cohesion: 0.24
Nodes (6): GAP_LG, GAP_MD, Contact(), Footer(), Gallery(), Hero()

### Community 4 - "ReservationModal.tsx"
Cohesion: 0.10
Nodes (32): groups, PuppyCard(), ReservationModal(), CheckRow(), CheckRowProps, describedBy(), Field(), FieldGroup() (+24 more)

### Community 5 - "validation.ts"
Cohesion: 0.10
Nodes (27): FAILURE_COPY, interestOptions, Status, FAILURE_COPY, ResultPanel(), FailureReason, deliverReservation(), DeliveryResult (+19 more)
